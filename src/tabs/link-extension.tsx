...
const LinkExtension = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      logger.debug("decodedParams", decodedParams);
    } catch (error) {
  ...
  const handleLinkExtension = async (confirm: boolean) => {
    ...
    try {
      ...
      chrome.runtime.sendMessage({
        type: "PUPU_EXTENSION_LINK_EXTENSION_CONFIRM",
        confirm: confirm,
      });
      ...
      <ThemeProvider>
        <div className="min-h-screen bg-gray-50/30 dark:bg-slate-950">
          <div className="max-w-md p-6 mx-auto">
            <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-slate-900 dark:border-slate-700">
              ...
              <div className="flex items-center justify-center gap-3 mb-6 ju">
                ...
                <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
                  {chrome.i18n.getMessage("linkExtensionTitle")}
                </h1>
              </div>
